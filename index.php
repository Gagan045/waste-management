  ...
  <div class="header">
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="getstarted scrollto" href="login1.php">Login</a></li>
          <li><a class="getstarted scrollto" href="registration1.php">Register</a></li>
          <li><a class="getstarted scrollto" href="#cont">Contact</a></li>
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(slide1.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Welcome to <span>EcoVision</span></h2>
