...
CREATE TABLE `food_donations` (
  ...
  KEY `name` (`name`),
  CONSTRAINT `food_donations_ibfk_1` FOREIGN KEY (`name`) REFERENCES `details` (`email`)
...
INSERT INTO `food_donations` VALUES ('ammuakki62@gmail.com','7416363886','Silluvu bomma road,allapuram,gannavaram',521101,8,1),('konduri.gagan04@gmail.com','7842559116','cfbgnhmu',585778,56,0);
